document.addEventListener('DOMContentLoaded', function() {
    ...
    // --- Panel Logic with Hash for Back Button ---
    const openSettings = () => {
    ...
    ['lang-bn', 'lang-en', 'theme-light', 'theme-dark', 'group-all', 'group-amar_routine', 'group-science', 'group-humanities', 'group-business'].forEach(id => {
